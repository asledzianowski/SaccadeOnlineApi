...
import numpy as np
import os
os.environ['Path'] += 'C:\\Program Files (x86)\\Intel\\openvino_2021.2.185\\deployment_tools\\ngraph\\lib;' \
    'C:\\Program Files (x86)\\Intel\\openvino_2021.2.185\\inference_engine\\external\\tbb\\bin;' \
    'C:\\Program Files (x86)\\Intel\\openvino_2021.2.185\\inference_engine\\bin\\intel64\\Release;' \
    'C:\\Program Files (x86)\\Intel\\openvino_2021.2.185\\inference_engine\\bin\\intel64\\Debug' \
    'C:\\Program Files (x86)\\Intel\\openvino_2021.2.185\\deployment_tools\\model_optimizer;' \
    'C:\\RELEASE\\backend\\src'
...
class Network:
    ...
    def _init_model(self, model_name, device, extensions):
        ...
        try:
            ...
            raise ValueError(str(model_name), "....Could not Initialise the network. Have you enterred the correct model path?",
                             str(e))
